...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/1.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/2.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/3.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/4.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/5.jpg" />"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt=""
				src="<c:url value="/assets/user/img/6.jpg" />"></a>
		</div>
	</div>
</section>
